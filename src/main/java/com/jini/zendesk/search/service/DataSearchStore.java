...
public class DataSearchStore {
    ...
    public void invokeSearchService(DataIndexStore indexStore) {
        ...
        System.out.println("Enter the search term::");//-> Extract this to a method
        String userInputField  = in.nextLine();
    ...
    public void displayOrgResult(String userInputField, String userInputValue, DataIndexStore indexStore) {
        ...
        if(!orgSearchIndex.containsKey(userInputField)){
            System.out.println("The search term provided is invalid. Please see the list if searchable fields and try again.");
            return;
        }

        if(!orgSearchIndex.get(userInputField).containsKey(userInputValue.toLowerCase())){
        ...
        System.out.println(PRINT_LINE);
        Set<Organization> orgSet = orgSearchIndex.get(userInputField).get(userInputValue.toLowerCase());
        orgSet.forEach(e -> {
        ...
        System.out.println(PRINT_LINE);
        System.out.println(PRINT_LINE);
        System.out.println("Found "+orgSet.size()+" records");
    }
    ...
    public void displayTicketResult(String userInputField, String userInputValue, DataIndexStore indexStore) {
        ...
        if(!ticketSearchIndex.containsKey(userInputField)){
            System.out.println("The search term provided is invalid. Please see the list if searchable fields and try again.");
            return;
        }

        if(!ticketSearchIndex.get(userInputField).containsKey(userInputValue.toLowerCase())){
            System.out.println("No records were found. Please try again");
            return;
        }
        ...
        System.out.println(PRINT_LINE);
        System.out.println(PRINT_LINE);
        System.out.println("Found "+ticketSet.size()+" records");
    }
    ...
    public void displayUserResult(String userInputField, String userInputValue, DataIndexStore indexStore) {
        ...
        if(!userSearchIndex.containsKey(userInputField)){
            System.out.println("The search term provided is invalid. Please see the list if searchable fields and try again.");
            return;
        }

        if(!userSearchIndex.get(userInputField).containsKey(userInputValue.toLowerCase())) {
            System.out.println("No records were found. Please try again");
            return;
        }
        ...
        System.out.println(PRINT_LINE);
        System.out.println(PRINT_LINE);
        System.out.println("Found "+userSet.size()+" records");
    }
